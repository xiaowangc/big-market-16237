...
CREATE TABLE `config_info` (
                               ...
                               `tenant_id` varchar(128) COLLATE utf8mb3_bin DEFAULT '' COMMENT '租户id',
                               ...
                               `encrypted_data_key` text COLLATE utf8mb3_bin NOT NULL COMMENT '加密data_key',
                               PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='config_info_aggr';
...
CREATE TABLE `his_config_info` (
                                   ...
                                   KEY `idx_did` (`data_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='his_config_info';
